...
// console.log("PreviewMessage", message, parsedContent, stringContent);
  return (
    <motion.div
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col w-full">
          ...
          {/* {stringContent &&  message.role === 'assistant' &&(
            <div className="flex flex-col gap-4 text-left">
